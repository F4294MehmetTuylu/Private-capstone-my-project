...
DATABASES = {
    'default': {
        ...
        'NAME': 'aws', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'aws.cx3hvkteofks.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'mehmettuylu-blog1' # please enter your s3 bucket name
